...
export function Navigation() {
  ...
  const { elementRef: ctaRef, transform: ctaTransform, handlers: ctaHandlers } =
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-1">
              ...
              <Button
                ref={ctaRef}
                className="ml-4 bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 text-white shadow-lg transition-all duration-300"
          ...
          {isOpen && (
            <div className="md:hidden">
              <div className="px-2 pt-2 pb-3 space-y-1 glass-pink rounded-2xl mt-2 border border-pink-200/50 shadow-xl">
                ...
                <Button className="w-full mt-4 bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 text-white shadow-lg">
                  Get Started
                </Button>
              </div>
            </div>
